        ...
        <Section className='pt-[12rem] -mt-[5.25rem]'
            ...
            <div className='container relative' ref={parallaxRef}>
                <div className='relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]'>
                    ...
                    <Button href='/pricing' white className='border-none'>
                        Get started
                    </Button>
                </div>
                        ...
                        <div className="relative bg-n-8 rounded-[1rem]">
                            ...
                            <div className="aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]">
                                ...
                                <ScrollParallax isAbsolutelyPositioned>
                                    <Generating className='absolute left-4 right-4 bottom-5 md:left-1/2 md:right-auto md:bottom-8 md:w-[32rem] md:-translate-x-1/2' />
                                </ScrollParallax>
                ...
                <ComapnyLogos className="hidden relative z-10 mt-10 lg:block"/>
            </div>
            <BottomLine />
        </Section>
    )
