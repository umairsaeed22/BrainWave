                ...
                <div className='lg:ml-auto xl-w-[38rem] mt-4'>
                    ...
                    <div className='relative left-1/2 flex w-[20rem] aspect-square border border-n-6 rounded-full -translate-x-1/2 scale:75 md:scale-100'>
                        <div className='flex w-60 aspect-square m-auto border border-n-6 rounded-full'>
                            <div className='m-[6rem] p-[0.2rem] aspect-square bg-conic-gradient rounded-full'>
                        ...
                        <ul className=''>
                            {collabApps.map((item, index) => (
                                <li key={item.id} className={`my-5 absolute top-0 left-1/2 h-1/2 -ml-[1.6rem] origin-bottom rotate-${index * 45}`}>
